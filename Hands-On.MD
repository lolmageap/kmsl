...
이러한 특징으로 인해 MongoDB는 RDBMS와 다르게 Join, Transaction, Schema 등의 기능이 부족하지만 대신 확장성이 뛰어나고 데이터를 저장, 조회 시 성능이 뛰어나다는 장점이 있습니다.
...
// 여기에 QueryDSL, Criteria API와 문법 비교 및 사용하지 않은 이유를 작성할지 고민중입니다.
