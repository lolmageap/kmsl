...
이로 인해 secondBasicQuery를 orderBy 함수로 생성할 때 originalBasicQuery 인스턴스 내부의 fieldsObject와 sortObject가 동일한 메모리 주소를 참조하게 되어 firstBasicQuery의 sortObject도 함께 변경되는 문제가 발생합니다.  
